        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              <div className="w-80 h-80 rounded-full overflow-hidden glass-card animate-float flex items-center justify-center bg-gradient-to-br from-primary/20 to-accent/20">
                <div className="text-6xl font-bold gradient-text">AD</div>
              </div>
              
              {/* Floating elements */}
              <div className="absolute -top-4 -right-4 w-20 h-20 rounded-full bg-gradient-to-r from-pastel-lavender to-pastel-blush opacity-60 animate-pulse"></div>
              <div className="absolute -bottom-6 -left-6 w-16 h-16 rounded-full bg-gradient-to-r from-neon-teal to-electric-blue opacity-40 animate-bounce"></div>
              
              {/* Glow effect */}
              <div className="absolute inset-0 w-80 h-80 rounded-full bg-gradient-to-r from-primary to-accent opacity-20 animate-glow -z-10"></div>
            </div>
          </div>
        </div>
      </div>
